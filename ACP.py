...
while running:
    ...
    if not won:
        ...
        if sprite1.rect.colliderect(sprite2.rect):
            sprite1.change_color(pygame.Color(random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)))
            sprite2.change_color(pygame.Color(random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)))
